...
# @Time    : 2021/7/14
# @Author  : Xuanyu Liu
# @File    : test_ContractCreateByCategory.py
# ****************************
import os
import allure
import pytest
...
class TestContract_Create:

    @allure.title("{case_data[title]}")
    @pytest.mark.parametrize("case_data", case_dict["test_case"])
    @allure.story("test_ContractCreateByCategory")
    def test_ContractCreateByCategory(self, case_data):
